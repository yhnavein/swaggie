...
import type { IHttpService, IRequestShortcutConfig, IPromise, IHttpHeadersGetter } from 'angular';
...
abstract class BaseService {
  ...
  protected processFull<T>(response: any): APIResponse<T> {
...
export class petService extends BaseService {
  ...
  */
  addPet(body: Pet ,
        config?: IRequestShortcutConfig
  ): IPromise<APIResponse<Pet>> {
    let url = `/pet?`;

    return this.$postFull(
      url,
      body,
      config
    );
...
export class storeService extends BaseService {
  ...
  */
  ...
  ): IPromise<APIResponse<Record<string, number>>> {
